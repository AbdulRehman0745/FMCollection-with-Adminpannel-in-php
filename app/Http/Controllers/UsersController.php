...
class UsersController extends Controller
{
    ...
    public function register(Request $request){
        ...
        $messageData = ['email'=>$input_data['email'],'name'=>$input_data['name']];
        Mail::send('users.register',$messageData, function($message) use($email){
            $message->to($email)->subject('Registration with ShoesZone');
        });
    }
