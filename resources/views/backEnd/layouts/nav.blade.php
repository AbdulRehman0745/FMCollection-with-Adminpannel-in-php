...
<div id="sidebar"><a href="{{url('/admin')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <li class="submenu {{$menu_active==5? ' active':''}}"> <a href="#"><i class="icon icon-th-list"></i> <span>Orders</span></a>
            ...
            <li class="submenu {{$menu_active==7? ' active':''}}"> <a href="#"><i class="icon icon-th-list"></i> <span>Messages</span></a>
                <ul>
                    <li><a href="{{route('admin.contact.messages')}}">Show Messages</a></li>
                    {{-- <li><a href="{{route('coupon.index')}}">List Coupons</a></li> --}}
                </ul>
            <li class="submenu {{$menu_active==6? ' active':''}}"> <a href="#"><i class="icon icon-th-list"></i> <span>Costumers</span></a>
                <ul>
                    <li><a href="{{route('user.index')}}">List Costumers</a></li>
                </ul>
        </li>
    </ul>
